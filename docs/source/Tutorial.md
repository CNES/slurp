...
<div align="center"><img src="_static/images/tutorials/strasbourg_vhr_image.png" alt="VHR image" title="VHR image"  width="40%"></div>
...
<tr>
<td>
<img src="_static/images/tutorials/ndvi.png" alt="NDVI image" title="NDVI image"  width="100%">
</td>
<td>
<img src="_static/images/tutorials/ndwi.png" alt="NDWI image" title="NDVI image"  width="100%">
</td>
<td>
<img src="_static/images/tutorials/texture.png" alt="Texture computation" title="Texture computation"  width="90%">
</td>
<td>
<img src="_static/images/tutorials/pekel.png" alt="Pekel mask" title="Pekel mask"  width="90%">
</td>
<td>
<img src="_static/images/tutorials/wsf.png" alt="WSF mask" title="WSF mask"  width="90%">
</td>
</tr>
<tr>
...
<table border="0" style="margin: auto; text-align: center;">
  <tr>
    <td>
      <img src="_static/images/tutorials/watermask_with_otb.png" alt="Water mask" title="Water mask" width="88%">
    </td>
    <td>
      <img src="_static/images/tutorials/vegmask_with_otb.png" alt="Low/High vegetation and bare ground mask" title="Low/High vegetation mask" width="82%">
    </td>
    <td>
      <img src="_static/images/tutorials/shadowmask_with_otb.png" alt="Shadow mask" title="Shadow mask" width="86%">
    </td>
    <td>
      <img src="_static/images/tutorials/urbanmask_with_otb.png" alt="Urban probability" title="Urban probability" width="98%">
    </td>
    <td>
      <img src="_static/images/tutorials/stackmask_with_otb.png" alt="Final mask" title="Final mask" width="90%">
    </td>
  </tr>
  <tr>
...
<table border="0" style="margin: auto; text-align: center;">
  <tr>
    <td>
      <img src="_static/images/tutorials/watermask_without_otb.png" alt="Water mask" title="Water mask" width="88%">
    </td>
    <td>
      <img src="_static/images/tutorials/vegmask_without_otb.png" alt="Low/High vegetation and bare ground mask" title="Low/High vegetation mask" width="82%">
    </td>
    <td>
      <img src="_static/images/tutorials/shadowmask_without_otb.png" alt="Shadow mask" title="Shadow mask" width="86%">
    </td>
    <td>
      <img src="_static/images/tutorials/urbanmask_without_otb.png" alt="Urban probability" title="Urban probability" width="98%">
    </td>
    <td>
      <img src="_static/images/tutorials/stackmask_without_otb.png" alt="Final mask" title="Final mask" width="90%">
    </td>
  </tr>
  <tr>
    <td><b>Water mask with style <code>conf/style_water.qml</code></b></td>
