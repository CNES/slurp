...
Tests are managed with `pytest <https://docs.pytest.org>`_ and use *markers* to select subsets of tests.

Available markers:

- **ci**: tests for Continuous Integration (CI).  
  Example:
  .. code-block:: bash

     pytest -m ci --config config_tests_ci.json --main_config main_config_tests_ci.json --cov=slurp

- **validation**: validate all algorithms (compute and compare against reference results).  
  Example:
  .. code-block:: bash

     pytest -m validation

- **features**: validate specific features.  
  Example:
  .. code-block:: bash
...
.. automodule:: tests.test_features.test_features_prepare
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_features.test_features_shadowmask
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_features.test_features_urbanmask
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_features.test_features_vegetation
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_features.test_features_watermask
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_valid.test_valid_sensor_geom
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_valid.test_valid_shadowmask
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_valid.test_valid_stackmask
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_valid.test_valid_urbanmask
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_valid.test_valid_vegetationmask
   :members:
   :undoc-members:
   :show-inheritance:

.. automodule:: tests.test_valid.test_valid_watermask
   :members:
   :undoc-members:
   :show-inheritance:
...
This installs the pre-commit hook in `.git/hooks/pre-commit` and `.git/hooks/pre-push` from `.pre-commit-config.yaml <https://raw.githubusercontent.com/CNES/slurp/master/.pre-commit-config.yaml>`_ file configuration.
...
``isort`` configuration is done in `.pyproject.toml <https://raw.githubusercontent.com/CNES/slurp/master/pyproject.toml>`_
...
``black`` configuration is done in `.pyproject.toml <https://raw.githubusercontent.com/CNES/slurp/master/pyproject.toml>`_
...
``flake8`` configuration is done in `setup.cfg <https://raw.githubusercontent.com/CNES/slurp/master/setup.cfg>`_
...
``pylint`` configuration is done in dedicated `.pylintrc <https://raw.githubusercontent.com/CNES/slurp/master/.pylintrc>`_ file.
...
**slurp** requires that contributors sign out a `Contributor LicenseAgreement <https://en.wikipedia.org/wiki/Contributor_License_Agreement>`_.
...
`Individual Contributor LicensingAgreement <https://github.com/CNES/slurp/blob/master/docs/source/CLA/ICLA-slurp.doc>`_ (ICLA) form and a
`Corporate Contributor Licensing Agreement <https://github.com/CNES/slurp/blob/master/docs/source/CLA/CCLA-slurp.doc>`_ (CCLA) form if you are
...
modified source files and also added to the `AUTHORS.md file <https://github.com/CNES/slurp/blob/master/AUTHORS.md>`_.
