...
class Shadows(BaseModel):
    ...
    percentile: Optional[int] = Field(default=2, description="Percentile value to cut histogram and estimate shadow threshold")
...
class Vegetation(BaseModel):
    ...
    filter_texture: Optional[int] = Field(..., description="Percentile for texture (between 1 and 99)")
    slic_seg_size: Optional[int] = Field(..., description="Approximative segment size")
    slic_compactness: float = Field(..., description="Balance between color and space proximity (see skimage.slic documentation)")
    nb_clusters_veg: Optional[int] = Field(..., description="Nb of clusters considered as vegetation (1-NB_CLUSTERS)")
    ...
    nb_clusters_low_veg: Optional[int] = Field(..., description="Nb of clusters considered as low vegetation (1-NB_CLUSTERS)")
